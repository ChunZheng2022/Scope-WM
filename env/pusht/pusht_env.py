...
# @markdown
# @markdown This environment follows the Push-T task formulation used by prior
# @markdown imitation-learning and world-model baselines.
...
class PushTEnv(gym.Env):
    ...
    def _add_segment(self, a, b, radius):
        ...
        shape.color = pygame.Color(
            "LightGray"
        )  # Pygame named colors: https://www.pygame.org/docs/ref/color.html
        return shape
